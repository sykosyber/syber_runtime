...
| Model capability envelope | v1 section 6 identifies model/API churn and access limits as risks; v1 Phase 3 and v1 section 7 require measured claims to preserve the conditions under which evidence was produced. | Harness reports record available role models, constraints, preferred unavailable models, and lower-bound interpretation. |
